                        ...
                        <div class="card-body p-md-5">
                            <div class="row justify-content-center">
                                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                    ...
                                    <form method="POST" action="{{ route('offerpostupdate', $user->id) }}"
                                        ...
                                        <div class="col-12">
                                            <label for="yourName" class="form-label">Update subtitle</label>
                                            <input type="text" name="subtitle" class="form-control" id="yourName"
                                                value="{{ $user->subtitle }}">
                                            <div class="invalid-feedback">Please enter your subtitle!</div>
                                        </div>
                                        <div class="col-12">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-4">
                                              ...
                                              <div class="mb-3">
                                                  ...
                                                  <input type="file" class="form-control" id="image" name="offerimage" accept="image/*" >
                                              </div>
                                            </div>
                                   ...
                                   <span class="position-relative"> <img  src="{{config('constants.Product_image_path') }}/{{ $user->offerimage }}" class="card-image" style="height:250px;width:250px;position:absolute;left:500px;right:0%; top:-300px;"></span>
                                </div>
