                        ...
                        <div class="card-body p-md-5">
                            <div class="row justify-content-center">
                                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                    ...
                                    <form method="POST" action="{{ route('clothing2postupdate', $user->id) }}"
                                   ...
                                   <span class="position-relative"> <img  src="{{config('constants.Clothing2_image_path') }}/{{ $user->clothimage }}" class="card-image" style="height:250px;width:250px;position:absolute;left:500px;right:0%; top:-300px;"></span>
                                </div>
